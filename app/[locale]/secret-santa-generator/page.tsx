...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return {
    ...
    keywords: ["secret santa generator", "secret santa organizer", "secret santa online", "amigo invisible", "amigo secreto", "gift exchange", "gift exchange generator", "free secret santa", "no email secret santa", "sorteo amigo invisible", "amigo oculto"],
    alternates: {
    ...
    openGraph: {
      title: t('title'),
      description: t('description'),
      url: `${baseUrl}/${locale}/secret-santa-generator`,
      type: "website",
      siteName: "Sorteo Pro",
      locale: locale === 'es' ? 'es_ES' : locale === 'pt' ? 'pt_PT' : 'en_US',
      images: [
        {
          url: `${baseUrl}/api/og?type=list`, // Using list type image for now
          width: 1200,
          height: 630,
          alt: t('title'),
        },
    ...
    twitter: {
      ...
      title: t('title'),
      description: t('description'),
      images: [`${baseUrl}/api/og?type=list`],
    },
  };
}
