...
export function RpsGeo() {
  const t = useTranslations("RpsGeo")
  const tFaq = useTranslations("RpsPage")
      ...
      <div className="max-w-4xl mx-auto px-4 relative z-10">
        ...
        >
          ...
          <div className="mb-10 space-y-4">
            <h2 className="text-3xl md:text-4xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-primary to-purple-300">
            ...
            <div className="prose prose-invert max-w-none">
              <p className="text-lg text-muted-foreground leading-relaxed">
                {t.rich("direct_answer_text", {
                  ...
                  tool: (chunks) => <Link href="/rock-paper-scissors" className="font-semibold text-primary hover:underline">{chunks}</Link>,
