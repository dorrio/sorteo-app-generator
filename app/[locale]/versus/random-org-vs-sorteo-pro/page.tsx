...
export async function generateMetadata({
  ...
  return {
    ...
    keywords: [
      "random.org alternative",
      "better random number generator",
      "free rng",
      "true randomness",
      "sorteo pro vs random.org",
      "generador de numeros aleatorios sin anuncios",
    ],
    alternates: {
...
export default async function RandomVersusPage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
  ...
  const softwareAppSchema = {
    ...
    name: "Sorteo Pro - Better Random.org Alternative",
