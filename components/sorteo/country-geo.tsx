  ...
  return (
    <section className="py-16 md:py-24 relative overflow-hidden">
            ...
            <div className="prose prose-invert max-w-none">
              <p className="text-lg text-muted-foreground leading-relaxed">
                {t.rich("direct_answer_text", {
                  ...
                  tool: (chunks) => <Link href="/random-country-generator" className="font-semibold text-primary hover:underline">{chunks}</Link>,
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden -z-10 pointer-events-none">
        ...
        <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-blue-500/5 rounded-full blur-3xl delay-1000" />
      </div>
    </section>
  )
}
