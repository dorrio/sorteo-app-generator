  ...
  return (
    <main className="min-h-screen bg-background text-foreground">
          ...
          <div
            ...
            dangerouslySetInnerHTML={{
              __html: DOMPurify.sanitize(
                t.raw("direct_answer_text") as string,
                {
        ...
        <div className="grid gap-6">
          {terms.map((item, idx) => (
            <div
              key={idx}
              id={item.id}
              className="p-8 rounded-2xl bg-card border border-border/50 hover:border-primary/50 transition-colors shadow-sm"
            >
      ...
      <section className="py-16 px-4 text-center">
        ...
        <Link
          href="/"
          className="inline-flex items-center justify-center bg-primary text-primary-foreground font-bold py-3 px-8 rounded-full hover:scale-105 transition-transform"
        >
          {t("cta_button")}
        </Link>
      </section>
