...
export async function generateMetadata({
  ...
  if (typeof colorParam === "string" && colorParam)
    ogParams.set("color", colorParam);
  ...
  if (typeof colorParam === "string" && colorParam)
    ogParamsUrl.set("color", colorParam);
      ...
      images: [
        {
          ...
          height: 630,
          alt: winnerName
            ? `${winnerName} - Official Winner`
            : "Official Sorteo Pro Verification Result",
        },
      ],
    },
    twitter: {
