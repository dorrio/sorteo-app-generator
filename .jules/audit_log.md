...
| 2026-02-13 | LCP & TBT | Refactored MainApp to MainAppOptimized (Server Component) | Reduced hydration cost by splitting monolithic client component into server shell and client islands. |
