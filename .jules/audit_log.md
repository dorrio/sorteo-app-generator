...
| 2026-02-03 | FCP & TBT | Implemented Client Islands Architecture | Refactored monolithic `MainApp` into `MainAppOptimized` Server Component with smaller Client Islands (`SorteoGameIsland`, `HeaderIsland`, etc.). Significantly reduced initial JS bundle size. |
