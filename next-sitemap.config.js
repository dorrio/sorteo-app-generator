...
module.exports = {
    ...
    transform: async (config, path) => {
        ...
        else if (path.includes('alternativa-appsorteos') || path.includes('instagram-comment-picker') || path.includes('wheel-of-names') || path.includes('glossary') || path.includes('random-number-generator')) {
            priority = 0.9;
            changefreq = 'weekly';
        }
