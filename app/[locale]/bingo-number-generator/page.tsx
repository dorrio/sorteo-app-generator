...
export async function generateMetadata({ params, searchParams }: Props) {
  ...
  const shareUrl = new URL(`${baseUrl}/${locale}/bingo-number-generator`);
  ...
  return {
    ...
    keywords: ["bingo number generator", "bingo caller", "random bingo numbers", "bingo 1-75", "virtual bingo cage", "90 ball bingo", "bingo caller app"],
    alternates: {
