...
import { ArrowRight, Lock, Zap, RefreshCw, Smartphone, HelpCircle, CheckCircle, PartyPopper } from "lucide-react"
...
export function TruthDareGeo() {
  ...
  const jsonLd = [
    ...
    },
    {
      ...
      description: t('direct_answer_text').replace(/<[^>]*>?/gm, '') // Strip HTML tags for Schema
    },
    {
      '@context': 'https://schema.org',
      '@type': 'HowTo',
