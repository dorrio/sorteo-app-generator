...
<JsonLd data={jsonLd} />
      <div className="max-w-4xl mx-auto px-4 relative z-10">
        ...
        >
          ...
          <div className="mb-10 space-y-4">
            <h2 className="text-3xl md:text-4xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-primary to-red-400">
            ...
            <div className="prose prose-invert max-w-none">
              <p className="text-lg text-muted-foreground leading-relaxed">
                {t.rich("direct_answer_text", {
                  ...
                  tool: (chunks) => <Link href="/secret-santa-generator" className="font-semibold text-primary hover:underline">{chunks}</Link>,
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden -z-10 pointer-events-none">
        ...
        <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-green-500/5 rounded-full blur-3xl delay-1000" />
      </div>
    </section>
  )
}
