...
export function ThemeInitializer({
  ...
  // Theme Params Handler & List Params Handler Logic
  useEffect(() => {
  ...
  }, [searchParams, updateTheme, hasHydrated, participants.length, addParticipants])
  ...
  useEffect(() => {
    ...
    if (initialTitle) {
      ...
      // Fallback logic handled by Server Component usually, but keeping store in sync
