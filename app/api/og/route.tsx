...
export async function GET(request: Request) {
  try {
    ...
    // --- DETERMINE THEME AND MODE ---
    // If name is present, we are in "Certificate Mode" (regardless of type)
    // If type is present, we apply that tool's theme (colors, icon)
    // If neither, fallback to generic

    const isCertificateMode = !!name || !type;

    // Theme Config based on type
    let themeConfig = {
        title: "Sorteo Pro",
        subtitle: "The Ultimate Giveaway Tool",
        bgGradient: "radial-gradient(circle at 50% 0%, #423506 0%, #09090b 70%)", // Default Gold/Zinc
        ...
        return new ImageResponse(
            (
                ...
                >
                    ...
                    {/* Corner Decorations */}
                    <div style={{ position: 'absolute', top: 30, left: 30, width: 20, height: 20, borderTop: '2px solid rgba(255,255,255,0.3)', borderLeft: '2px solid rgba(255,255,255,0.3)' }} />
                    <div style={{ position: 'absolute', top: 30, right: 30, width: 20, height: 20, borderTop: '2px solid rgba(255,255,255,0.3)', borderRight: '2px solid rgba(255,255,255,0.3)' }} />
                    <div style={{ position: 'absolute', bottom: 30, left: 30, width: 20, height: 20, borderBottom: '2px solid rgba(255,255,255,0.3)', borderLeft: '2px solid rgba(255,255,255,0.3)' }} />
                    <div style={{ position: 'absolute', bottom: 30, right: 30, width: 20, height: 20, borderBottom: '2px solid rgba(255,255,255,0.3)', borderRight: '2px solid rgba(255,255,255,0.3)' }} />
                    ...
                    <div style={{
                        ...
                        <div style={{
                            ...
                            gap: '10px',
                            padding: '8px 20px',
                            backgroundColor: `${themeConfig.accentColor}26`, // 15% opacity
                            border: `1px solid ${themeConfig.accentColor}4D`, // 30% opacity
                            borderRadius: '100px',
                            marginBottom: '30px',
                        }}>
                            <svg width="24" height="24" viewBox="0 0 24 24" fill={themeConfig.accentColor}>
                        ...
                        <div style={{
                            ...
                            width: '600px',
                             ...
                             <div style={{
                                ...
                                {themeConfig.title} - Create Your Own
                             </div>
                             ...
                             <div style={{
                                ...
                                <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke={themeConfig.accentColor} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                                    ...
                                    <span style={{ fontSize: 20, color: themeConfig.accentColor, fontWeight: 'bold', letterSpacing: '1px' }}>SORTEO PRO</span>
                                </div>
                                ...
                                <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
                                    <span style={{ fontSize: 18, color: 'rgba(255,255,255,0.6)', fontFamily: 'monospace' }}>{dateStr}</span>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    // --- TOOL SPECIFIC LANDING PAGE RENDER (Default existing logic for no name) ---
        ...
        >
             ...
             <div style={{ zIndex: 10, display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                ...
                <h1 style={{
                    ...
                    background: type === 'instagram' ? 'white' : `linear-gradient(to bottom, white, ${themeConfig.accentColor})`,
                    backgroundClip: 'text',
                    color: 'transparent',
                }}>
                    {themeConfig.title}
