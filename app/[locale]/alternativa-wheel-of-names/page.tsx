...
export async function generateMetadata({
  ...
  return {
    ...
    alternates: {
      canonical: `/alternativa-wheel-of-names`,
      languages: {
        en: `/en/alternativa-wheel-of-names`,
        es: `/es/alternativa-wheel-of-names`,
        pt: `/pt/alternativa-wheel-of-names`,
      },
    },
  };
}

export default async function VersusWheelPage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
  ...
  const breadcrumbJsonLd = {
    ...
    itemListElement: [
      ...
      },
      {
        ...
        item: `${baseUrl}/${locale}/alternativa-wheel-of-names`,
      },
    ],
  };
  ...
  return (
    <main className="min-h-screen bg-background text-foreground">
      ...
      <header className="bg-background border-b border-border/50 py-20 px-4 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <h1 className="text-4xl md:text-6xl font-extrabold tracking-tight mb-6 leading-tight">
            {t("header_title_part1")}{" "}
            <span className="text-primary">{t("header_title_part2")}</span>
          </h1>
      ...
      <section className="bg-background relative z-10">
        <ComparisonTable namespace="VersusWheel.table" />
      </section>
      ...
      <section className="py-16 bg-background">
        <VersusFAQ namespace="VersusWheel.faq" />
      </section>
