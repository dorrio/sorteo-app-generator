...
export function DiceGeo() {
  const t = useTranslations("DiceGeo")
  const tFaq = useTranslations("DicePage")
            ...
            <div className="prose prose-invert max-w-none">
              <p className="text-lg text-muted-foreground leading-relaxed">
                {t.rich("direct_answer_text", {
                  ...
                  tool: (chunks) => <Link href="/dice-roller" className="font-semibold text-primary hover:underline">{chunks}</Link>,
