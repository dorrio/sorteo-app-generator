...
export async function generateMetadata({ params, searchParams }: Props) {
  ...
  // Using rng as it matches the randomness mechanics
  ...
  return {
    ...
    keywords: ["rock paper scissors online", "piedra papel tijera online", "pedra papel tesoura online", "rps game", "online rps", "rock paper scissors generator"],
    alternates: {
...
export default async function RpsPage({ params }: { params: Promise<{ locale: string }> }) {
  ...
  const softwareAppSchema = {
    ...
    name: 'Online Rock Paper Scissors by Sorteo Pro',
  ...
  return (
    <>
      ...
      />
      {/*
        initialStyle="cards" provides a nice visual for options.
        seoMode="rps" triggers the specific logic in MainApp.
      */}
