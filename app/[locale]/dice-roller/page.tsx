...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return {
    ...
    openGraph: {
      ...
      images: [
        {
          url: `${baseUrl}/api/og?type=dice&title=${encodeURIComponent(t('title'))}&color=%23e11d48`,
          width: 1200,
          height: 630,
          alt: t('title'),
        },
    ...
    twitter: {
      ...
      title: t('title'),
      description: t('description'),
      images: [`${baseUrl}/api/og?type=dice&title=${encodeURIComponent(t('title'))}&color=%23e11d48`],
    },
  };
}
